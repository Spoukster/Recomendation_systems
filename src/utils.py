...
def prefilter_items(data, item_features, purchases_weeks=52, take_n_popular=5000):
    ...
    weeks = purchases_last_week[purchases_last_week['week_no'] > data['week_no'].max() - purchases_weeks].item_id.tolist()
